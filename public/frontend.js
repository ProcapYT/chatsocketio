...
const usernameErrorContainer = document.querySelector('#usernameErrorContainer')
...
socket.on('userList', users => {
    userNames.innerHTML = users.map(username => `<p><i class="fa-solid fa-user"></i>&nbsp;${username}</p>`).join('')
